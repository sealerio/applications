...
see : [default ceph block Clusterfile examples](blob/main/rookceph/rookceph-block/examples/Clusterfile.yaml)
...
see: [mysql with ceph block examples](blob/main/rookceph/rookceph-block/examples/examples.yaml)
